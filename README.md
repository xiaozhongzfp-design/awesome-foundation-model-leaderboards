...
| [CLBench](https://www.clbench.com) | CLBench is a benchmark to evaluate the ability of LMs to learn new knowledge from provided context, covering domain knowledge reasoning, rule system application, procedural task execution, and empirical discovery. |
...
| [LLM Confabulation/Hallucination Leaderboard](https://github.com/lechmazur/confabulations?tab=readme-ov-file#50-50-ranking-leaderboard) | LLM Confabulation/Hallucination Leaderboard evaluates LLMs based on how often they produce non-existent answers (confabulations or hallucinations) in response to misleading questions based on provided text documents, making it particularly useful for RAG scenarios. |
...
| [LiveCodeBench GSO](https://livecodebench.github.io/gso.html) | LiveCodeBench GSO is a benchmark to evaluate code models on generation, self-repair, and optimization tasks. |
...
| [RubberDuckBench](https://cs.brynmawr.edu/RubberDuckBench/#leaderboard) | RubberDuckBench is a benchmark to evaluate LLMs on code explanation capabilities, inspired by the rubber duck debugging technique. |
...
| [MMOU](https://mmou-bench.github.io) | MMOU (Massive Multi-Task Omni Understanding) is a benchmark to evaluate omni-modal models on long-form audio-visual reasoning over real-world web videos. |
...
| [RedCode](https://redcode-agent.github.io/#leaderboard) | RedCode is a benchmark to evaluate the safety of AI coding agents. |
